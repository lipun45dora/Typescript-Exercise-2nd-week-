...
console.log("Value1=" + map.get('w3school'));
console.log("Value1=" + map.get('3')); //map.get-It returns undefined if the key does not exist in the map.
console.log("Value1=" + map.get('value'));
